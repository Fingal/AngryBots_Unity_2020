...
public class CollisionSystem : JobComponentSystem
{
	...
	[BurstCompile]
	struct CollisionJob : IJobEntityBatch {
		public float radius;
		...
		{
			var chunkHealths = batchInChunk.GetNativeArray(healthType);
			var chunkTranslations = batchInChunk.GetNativeArray(translationType);
